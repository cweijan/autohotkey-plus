...
All checks are found in [📄 `package.json#scripts`](https://github.com/vscode-autohotkey/vscode-autohotkey-plus/blob/main/package.json).
...
The syntax in [📄 `language/ahk.tmLanguage.yaml`](https://github.com/vscode-autohotkey/vscode-autohotkey-plus/blob/master/language/ahk.tmLanguage.yaml) determines how the syntax highlighting is applied.

```
; No syntax highlighting for me 😞
LAlt::
    doThing() ; I'm a comment!
return
```
...
-   If you're curious, [`microsoft/vscode-textmate`](https://github.com/microsoft/vscode-textmate) hosts the tokenization logic.
...
1. ➕ Add a new file in [📁 `src/test/suite/grammar/samples`](https://github.com/vscode-autohotkey/vscode-autohotkey-plus/tree/master/src/test/suite/grammar/samples) that demonstrates the issue
